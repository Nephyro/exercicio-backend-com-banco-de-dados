...
app.post('/v1/senai/filme/pessoa/filme', bodyParserJSON, async function(request, response){
    // Recebe o conteúdo dentro do body da requisição e armazena em uma variável local
    let dados = request.body
    // Recebe o content type da requisição, para validar se é um JSON
    let contentType = request.headers['content-type']
...
app.get('/v1/senai/filme/pessoa/filme', async function(request, response){
...
// Endpoint para Listar um filme pelo ID
app.get('/v1/senai/filme/pessoa/filme/:id', async function(request, response){
    // Recebe o ID via parâmetro
    let id = request.params.id
...
app.put('/v1/senai/filme/pessoa/filme/:id', bodyParserJSON, async function(request, response){
    // Recebe o content type da requisição
    let contentType = request.headers['content-type']
    // Recebe o ID do registro a ser atualizado
    let id = request.params.id
...
app.delete('/v1/senai/filme/pessoa/filme/:id', async function(request, response){
    let id = request.params.id
